            ...
            !(function() {
                    ...
                    D = function(e) {
                        if ((e = e || _.event)) {
                            ...
                            if (O && r === y && 'error' === e.type) {
                                var a = e;
                                !0 === (n = o && o.call(this, a.message, a.filename, a.lineno, a.colno, a.error)) &&
                                    e.preventDefault();
                ...
                function V(e, t, n) {
                            ...
                            if ((t = t || e.event)) {
                                ...
                                if (r)
                                    if (1 === r.length) _(r[0], n, t);
                                        ...
                                        for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[X]); a++)
                                            _(o[a], n, t);
                            }
                        },
                        b = function(t) {
                    ...
                    function k(t, n) {
                        ...
                        var C = i
                                ? function(e) {
                                      if (!S.isExisting)
                                          return z(e), P.call(S.target, S.eventName, S.capture ? b : m, S.options);
                                  }
                                : function(e) {
                            ...
                            I = i
                                ? function(e) {
                                      ...
                                      if (e.allRemoved)
                                          return D.call(e.target, e.eventName, e.capture ? b : m, e.options);
                                  }
                                : function(e) {
                                        ...
                                        if (!s || s(t, d, l, arguments)) {
                                            ...
                                            if (L)
                                                for (var m = 0; m < L.length; m++)
                                                    if (h === L[m]) return t.apply(this, arguments);
                                            var b = !1;
                                            void 0 === y
                                                ? (g = !1)
                                                : !0 === y
                        ...
                        return (
                            ...
                            (T[c] = function() {
                                for (
                                    var t = this || e, n = arguments[0], r = [], o = J(t, O ? O(n) : n), a = 0;
                                    a < o.length;
                                    a++
                                ) {
                                    var i = o[a],
                                        ...
                                        if (s) {
                                            ...
                                            for (v = 0; v < f.length; v++)
                                                this[a].call(
                                                    this,
                                                    n,
                                                    (h = f[v]).originalDelegate ? h.originalDelegate : h.callback,
                                                    h.options
                                                );
                                        }
                                        if (c)
                ...
                function ae(e, t, n) {
                    return (
                        ...
                        n.configurable ||
                            (e[ne] || Object.isFrozen(e) || $(e, ne, { writable: !0, value: {} }),
                            e[ne] && (e[ne][t] = !0)),
                        n
                    );
                }
                            ...
                            vh: function(e, t, n, r) {
                                if (!d && g) {
                                    if (v)
                                        try {
                                            var o;
                                            if ('[object FunctionWrapper]' === (o = t.toString()) || o == y)
                                                return e.apply(n, r), !1;
                                        } catch (a) {
                                            return e.apply(n, r), !1;
                                        }
                                    else if ('[object FunctionWrapper]' === (o = t.toString()) || o == y)
                                        return e.apply(n, r), !1;
                                } else if (v)
                                    try {
                                        t.toString();
                                        ...
                                        self.addEventListener(
                                            ...
                                            function(t) {
                                                ...
                                                for (o = i ? i.constructor.name + '.' + a : 'unknown.' + a; i; )
                                                    i[a] &&
                                                        !i[a][n] &&
                                                        (((r = e.wrapWithCurrentZone(i[a], o))[n] = i[a]), (i[a] = r)),
                                                        (i = i.parentElement);
                                            },
                                            !0
                                        );
                                ...
                                var m = 'readystatechange',
                                    ...
                                    w = R(f, 'send', function() {
                                        return function(e, n) {
                                            ...
                                            e && !0 === e[s] && !o.aborted && a.state === b && a.invoke();
                                        };
                                    }),
